...
Config.Alerts = {
    ...
    ['wheat_picking'] = 'Collecting Wheat',
    ['wheat_progressbar'] = 'Making Grain',
    ['wheat_processing'] = 'Removed ' ..Config.WheatProcessing.. ' Wheat',
    ['grain_processed'] = 'Made ' ..Config.WheatProcessed.. ' Grains',
    ['error_wheat'] = 'Seems like you don\'t have any wheat to process... Come Back Later!',
