# Edited with a new location, new crop, updated instructions, and a unique ymap made by Suritoba
...
```
	...
	["wheat"] 							= {["name"] = "wheat",  	     		["label"] = "Wheat",	 		["weight"] = 25, 		["type"] = "item", 		["image"] = "wraps.png", 				["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,   	["combinable"] = nil,   ["description"] = ""},
["grain"] 							= {["name"] = "grain",  	     		["label"] = "Grain",	 		["weight"] = 25, 		["type"] = "item", 		["image"] = "grain_oatmeal.png", 				["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,   	["combinable"] = nil,   ["description"] = ""},
```
...
## QB-Target and menu is all done within the config of tr-farming/config.lua
