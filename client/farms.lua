...
PumpkinField = {
 ...
 CornFields = {
    [1] = {
        label = "Corn Field",
        BlipCoord = vector3(2849.91, 4593.00, 47.59),
        Blip = 1,
        BlipColor = 42,
        zones = {
            vector2(2882.8610839844, 4677.021484375),
            vector2(2899.8200683594, 4589.62890625),
            vector2(2845.7204589844, 4568.5966796875),
            vector2(2836.1530761719, 4590.294921875),
            vector2(2816.3239746094, 4585.8959960938),
            vector2(2799.1154785156, 4653.501953125)
        },
        minZ = 44.68,
        maxZ = 48.33
    },
